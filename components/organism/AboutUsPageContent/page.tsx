                    ...
                    <div className=" flex flex-col gap-[50px] max-w-[645px] flex-wrap">
                        ...
                        <div className={'flex flex-col md:flex-row justify-between'}>
                            {aboutList1.map((item, i) => (
                                <div key={i} className={'flex flex-row items-center justify-start'}>
                                    <BiCheck size={'34px'} className={'text-primary'}/>
                                    <Text variant={'subheading'}
                                          className={'text-muted-foreground'}>{t(`ticks.${item.name}`)}</Text>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-[50px] max-w-[645px]">
                        <div>
                            <Text className={'text-[28px]'}>
                                ...
                                <span className={'text-primary'}> {t('about_kizuna.mission_text2')}</span>
                            </Text>
                        </div>
                        ...
                        <div
                            className={'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full  md:justify-items-start justify-items-start'}>
                            {aboutList2.map((item, i) => (
                                <div key={i} className={'flex flex-row items-center md:justify-center justify-center '}>
                                    <BiCheck size={'34px'} className={'text-primary'}/>
                                    <Text variant={'subheading'} className={'text-muted-foreground'}>{t(`ticks.${item.name}`)}</Text>
                                </div>
                            ))}
                        </div>
