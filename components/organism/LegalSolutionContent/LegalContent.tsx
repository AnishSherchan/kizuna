...
const LegalContent = () => {
    ...
    return (
        <ContentWrapper heading={t("heading")} subHeading={t("subHeading")}
                        headingSpan={t("headingSpan")}>
            <div
                className={'flex w-full h-full flex-col gap-[40px] lg:flex-row justify-between items-center lg:items-stretch lg:flex-nowrap flex-wrap'}>
                {/*Image*/}
